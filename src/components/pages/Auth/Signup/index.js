              ...
              #f7fafc`,
                ...
                <Grid xs={4} sx={{ pl: 10, mx: 'auto' }}>
                    <Stack gap={4}>
                        ...
                        />
                        <Typography>
                            The creator platform for NFTs. Launch the next big
                            collection with Ambition.
                        </Typography>
                        <Stack gap={1} direction="row">
                            ...
                            <Stack>
                                ...
                                <Typography
                                    variant="body"
                                    sx={{ opacity: 0.8 }}>
                                    Turn layers of traits into a
                                    production-ready 10,000 NFT collection.
                                </Typography>
                            </Stack>
                        </Stack>
                        <Stack gap={1} direction="row">
                            ...
                            <Stack>
                                ...
                                <Typography
                                    variant="body"
                                    sx={{ opacity: 0.8 }}>
                                    Upload your generated collection onto a
                        ...
                        <Stack gap={1} direction="row">
                            ...
                            <Stack>
                                ...
                                <Typography
                                    variant="body"
                                    sx={{ opacity: 0.8 }}>
                                    Release a website for users to mint NFTs
                        ...
                        <Stack
                            ...
                            <Typography>
                                &quot;#NFT smart contract &amp; minting website
                                made with the help of @ambition_so. It was so
                                easy and fast!&quot;
                            </Typography>
