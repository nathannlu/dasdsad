    ...
    return (
        <Fade in>
            <Box
                sx={{
                    backgroundImage:
                        'url(https://uploads-ssl.webflow.com/61a5732dd539a17ad13b60fb/6208747ded33564312b6ef56_background.png)',
                ...
                <Grid xs={7} sx={{ bgcolor: 'white', px: 18 }}>
                    <Stack
                        ...
                        <Typography variant="body1">
                            ...
                            password. If you don’t have access to your email
                            anymore, please contact support.
                        </Typography>
                        ...
                        <form
                            ...
                            <Stack gap={2}>
                                ...
                                <Stack direction="row" alignItems="center">
                                    ...
                                    <Link to="/login" className="link ml-8">
                                        Return to login
                                    </Link>
                                </Stack>
                            </Stack>
