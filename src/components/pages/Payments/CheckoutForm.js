...
const CheckoutModal = ({ contractId, planId, callback }) => {
    ...
    return (
        <form
            ...
            <Stack sx={{ bgcolor: 'grey.100', p: 4 }} direction="row" gap={4}>
                <Grid item xs={7}>
                    <Stack gap={2}>
                        <Typography variant="h5">Billing frequency</Typography>
                                ...
                                <Card
                                    ...
                                    <Stack gap={3}>
                                        ...
                                        <Typography variant="small">
                                            ${price.unit_amount / 100} billed
                                            once a {price.frequency}
                                        </Typography>
                                    </Stack>
                                </Card>
                            ))}
                        ...
                        <Card sx={{ p: 2 }}>
                            <Stack gap={2}>
                                ...
                                <LoadingButton
                                    ...
                                    variant="contained"
                                    fullWidth>
                                    Pay ${selectedPlan?.unit_amount / 100} USD
                                    now
                                </LoadingButton>
                            </Stack>
                        </Card>
