...
import { LoadingButton, Card, Typography, Divider, CardElement, Button, Select, MenuItem } from 'ds/components';
...
const ConfirmationModal = (props, ref) => {
    ...
    return (
        ...
        >
            <DialogTitle>{confirmationData && confirmationData.title}</DialogTitle>
            <DialogContent>
                <DialogContentText>
