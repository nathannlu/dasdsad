...
export const useSolana = () => {
    ...
    const payerWallet = Keypair.fromSecretKey(
        Uint8Array.from([
            250, 198, 88, 219, 95, 186, 86, 42, 141, 139, 158, 202, 48, 60, 49,
            34, 120, 169, 71, 222, 72, 218, 184, 243, 52, 128, 63, 244, 245, 30,
            61, 29, 0, 73, 114, 112, 87, 75, 67, 11, 212, 182, 193, 17, 29, 222,
            23, 63, 5, 89, 155, 72, 191, 85, 51, 105, 87, 89, 155, 55, 11, 21,
            29, 75,
        ])
    );
    ...
    const deploySolanaContract = async (payerWallet, creators) => {
        ...
        const res = await createCandyMachineV2(
            ...
            null, // splToken
            {
                ...
                creators: [
                    {
                        address: '127xW67HTbXXzYvwzU4aZaz6vkY7cyPyycmsrLz5Q4cz',
                        verified: true,
                        share: 100,
                    },
                ],
