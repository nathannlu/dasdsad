...
export const RenderNode = ({ render }) => {
    ...
    const { id, isActive, isHover, dom, deletable, isNavOrHeader } = useNode(
        (node) => ({
    ...
    const currentNodeIndex = node('ROOT')
        .get()
        .data.nodes.findIndex((arrItem) => arrItem == id);
