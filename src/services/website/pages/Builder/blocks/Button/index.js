...
const Button = ({ isMint, text, link }) => {
    const { onMint, contract, size, setMintCount, mintCount, price, onConnect } = useMintButton();
		...
		<div className='flex flex-col'>
            <div className='flex'>
                {size !== -1 ? (
                    ...
                    <button onClick={onConnect} class="flex text-white bg-orange-500 border-0 py-2 px-8 focus:outline-none hover:bg-orange-600 rounded text-lg">
