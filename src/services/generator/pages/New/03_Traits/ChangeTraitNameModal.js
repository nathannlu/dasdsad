...
const ChangeTraitNameModal = ({ isModalOpen, setIsModalOpen, editTrait }) => {
    ...
    const { newTraitNameForm, onSubmit } = useNewTraitNameForm({
        editTrait,
        isModalOpen,
        setIsModalOpen,
    });
        ...
        <Modal
            ...
            <form
                ...
                <Box
                    ...
                    <Typography variant="h6">Edit trait name</Typography>
                </Box>
                <Stack sx={{ bgcolor: 'grey.100', p: 2 }} gap={4}>
                    <Box>
