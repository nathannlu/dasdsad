...
import { Typography, Dialog, DialogContent, DialogContentText, DialogTitle, Stack } from '@mui/material';
...
const DownloadModal = ({downloadModalState, setDownloadModalState}) => {
    ...
    return (
        <Dialog open={downloadModalState} onClose={() => setDownloadModalState(false)}>
            <DialogTitle variant='h4'>Downloading your collection... ✨</DialogTitle>
            <DialogContent>
